...
require('kem_lib/damage')
require('kem_lib/status_effect')
require('kem_lib/poison')
require('kem_lib/poisoned_units')
require('kem_lib/kem_attributes')
...
function GameMode:ExampleConsoleCommand()
  ...
  kemPrint( '******* Example Console Command ***************' )
